...
<!------------------------------------------- PUBLIC ------------------------------------------>
	...
	<cffunction name="imageUpload" hint="handle image uploads" access="public" returntype="void" output="false">
		<cfargument name="event" type="any">
			<cfscript>
				arguments.event.setLayout("Layout.Ajax");
				arguments.event.setView('wiki/imageUpload');
			</cfscript>
	</cffunction>
...
<!------------------------------------------- PRIVATE ------------------------------------------->
	...
	<cffunction name="manage" hint="manage a wiki page" access="private" returntype="void" output="false">
		...
		<cfscript>
			...
			rc.jsappendList &= ",markitup/jquery.dimensions,markitup/ui.mouse,markitup/ui.draggable,markitup/ui.draggable.ext,markitup/InlineUpload";
