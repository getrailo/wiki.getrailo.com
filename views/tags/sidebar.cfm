...
<cfif refindnocase("^profile",event.getCurrentEvent())>
	...
	<h5 onclick="toggleItems('sb_profile')"> <img src="includes/images/shield.png" alt="usermenu"/> User Menu</h5>
...
<cfelse>
	<!--- Wiki Main Menu --->
	<h5 onclick="toggleItems('sb_wikimenu')"> <img src="includes/images/home.png" alt="home"/> SideBar</h5>
