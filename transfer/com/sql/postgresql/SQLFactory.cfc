...
Purpose:    The SQL Factory for postgresql
...
<cfcomponent hint="The SQL Factory for postgresql" extends="transfer.com.sql.SQLFactory" output="false">
...
<cffunction name="getTransferInserter" hint="returns the transfer inserted" access="public" returntype="transfer.com.sql.TransferInserter" output="false">
	<cfreturn getSingleton("transfer.com.sql.postgresql.TransferInserter") />
</cffunction>
...
<cffunction name="getTransferSelecter" hint="returns the transfer inserted" access="public" returntype="transfer.com.sql.TransferSelecter" output="false">
	<cfreturn getSingleton("transfer.com.sql.postgresql.TransferSelecter") />
</cffunction>
